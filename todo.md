...
## Créer le système de simulation de dégâts :
    - Pire et meilleur scénario en fonction des IV/EV/Nature, du talent, de la météo, du terrain et de la répartition des EV (sans oublier les altérations de stats).
    - Pouvoir choisir des altérations de stats pour le pokémon attaqué ET le pokémon attaquant.
    - Pouvoir choisir les IV/EV/Nature/talent/objet pour le pokémon attaqué ET le pokémon attaquant.
